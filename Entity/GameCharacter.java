...
public abstract class GameCharacter implements Damageable{
    ...
    public GameCharacter(String name, String charClass, String type, String weapon, int healthPoints, int manaPoints) {
        this.name = name;
    ...
    public final void useSkill(int skill, MobNPC target, GameCharacter ally, GameCharacter[] party) {
    ...
    protected abstract void performSkill(int skill, MobNPC target, GameCharacter ally, GameCharacter[] party);
